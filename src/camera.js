...
export class FirstPersonControls {
    ...
    setupEventListeners() {
        ...
        // Only request pointer lock when not in landscape mode
        // This will be controlled by the main app
        this.shouldRequestPointerLock = true;
        
        document.addEventListener('click', () => {
            // Only request pointer lock if enabled (not in landscape mode)
            if (this.shouldRequestPointerLock) {
